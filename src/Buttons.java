...
public class Buttons {
  ...
  private static Dimension buttonSize = new Dimension(170, 25);
  ...
  public static Component saveCoords(){
    ...
    saveCoords.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        saveCoords.setText("Save in: 3");
        final Timer save = new Timer(1000, new ActionListener() {
          int x = 2;
          
          @Override
          public void actionPerformed(ActionEvent e) {
            saveCoords.setText("Save in: " + Integer.toString(x));
            x--;
            if (x < 0){
              ((Timer)e.getSource()).stop();
              saveCoords.setText("SAVE MOUSE CORDS");
